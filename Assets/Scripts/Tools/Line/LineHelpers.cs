...
namespace Sibz.Lines
{
    public static class LineHelpers
    {
        ...
        public static void GetSlopeInterceptForm(float2 origin, float2 direction, out float3 slopeIntercept)
        {
            ...
            var result = new float3(direction.y - origin.y, origin.x - direction.x, 0f);
        ...
        public static bool TransformsCrossPaths2D(Transform tx1, Transform tx2)
        {
            ...
            return LineLineIntersection(out var intersection, pos1, dir1, pos2, dir2);
        ...
        {
            return ((float3) direction).GetSideOfLineXZ(point);
        }
        ...
        {
            float dot = direction.x * -test.y + direction.y * test.x;
